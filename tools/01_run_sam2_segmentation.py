...
class MaskLabelToolkit:
    def __init__(self, device: str = "cpu", debug: bool = False) -> None:
        ...
        self._save_folder = PROJECT_ROOT / "datasets/tmp"
    ...
    def _on_save_mask(self):
        ...
        write_mask_image(f"{self._save_folder}/mask_image.png", mask)
        # Save the mask visualization
        write_rgb_image(f"{self._save_folder}/mask_image_vis.png", mask_vis)
        # Save prompt data
